...
function CastVPredQ(unit)
	if SpellReady.Q and ValidTarget(unit) and myHero.mana >= ManaCost(Q) then
		...
		if HitChance >= AutoCarry.PluginMenu.spelloptions.qoptions.HitChance and GetDistance(CastPosition) <= SpellQ.Range then
...
function CastVPredW(unit)
	if SpellReady.W and ValidTarget(unit) and myHero.mana >= ManaCost(W) then
		...
		if HitChance >= AutoCarry.PluginMenu.spelloptions.woptions.HitChance and GetDistance(unit) <= SpellW.Range then
...
function CastVPredR(unit)
	if SpellReady.R and ValidTarget(unit) and myHero.mana >= ManaCost(R) then
		...
		if HitChance >= AutoCarry.PluginMenu.spelloptions.roptions.HitChance and GetDistance(CastPosition) <= SpellR.Range then
